...
CREATE TABLE `trabajan` (
  ...
  PRIMARY KEY (`id_laboratorio`,`id_cientifico`),
  KEY `id_cientifico` (`id_cientifico`),
  CONSTRAINT `trabajan_ibfk_1` FOREIGN KEY (`id_laboratorio`) REFERENCES `laboratorio` (`id`),
  CONSTRAINT `trabajan_ibfk_2` FOREIGN KEY (`id_cientifico`) REFERENCES `cientificos` (`id`)
...
INSERT INTO `trabajan` VALUES (1,1),(1,2),(3,3),(4,4),(3,5);
