...
CREATE TABLE `compuesto` (
  ...
  PRIMARY KEY (`id_clinicas`,`id_laboratorio`),
  KEY `id_laboratorio` (`id_laboratorio`),
  CONSTRAINT `compuesto_ibfk_1` FOREIGN KEY (`id_clinicas`) REFERENCES `clinicas` (`id`),
  CONSTRAINT `compuesto_ibfk_2` FOREIGN KEY (`id_laboratorio`) REFERENCES `laboratorio` (`id`)
...
INSERT INTO `compuesto` VALUES (1,1),(2,1),(3,3),(4,4),(5,5);
