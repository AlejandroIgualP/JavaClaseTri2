...
public class Main {
    public static void main(String[] args) {
        ...
        if (correo_valido.matches()){System.out.println("El correo: "+correo+" es valido");}
            ...
            try {
                throw new CorreoIncorrectoException("El correo: "+correo+" es incorrecto");
            } catch (CorreoIncorrectoException e)
            {System.out.println(e.fillInStackTrace());}
        }
    }

    private static class CorreoIncorrectoException extends Throwable {
        public CorreoIncorrectoException(String s) {
        }
    }
}
